...
import { Heart, RotateCcw, ArrowLeft, Users, Heart as HeartIcon, BookOpen, Smile, Plane, DollarSign, Shield, Dice6, Theater, HelpCircle, MessageCircle, Shuffle, ChevronDown, Check } from 'lucide-react'
      ...
      <div className="flex items-center justify-center" style={{perspective: '1000px'}}>
        <div className="relative flex items-center justify-center" style={{width: '320px', height: '500px'}}>
          ...
          <animated.div
            ...
            className="relative backdrop-blur-xl bg-black/35 rounded-3xl p-8 cursor-grab active:cursor-grabbing no-select touch-none overflow-hidden z-10 flex items-center justify-center"
          >
